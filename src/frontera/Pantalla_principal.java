...
public class Pantalla_principal extends javax.swing.JFrame {
    ...
    public static ArrayList<cell> listaCell  ; 
    ...
    public static SistemaCatalogo sistemacatalogo = new SistemaCatalogo();
    ...
    public static void main(String args[]) {
        ...
        /*
        listaCell=new ArrayList<cell>();
        cell nuevo = new cell("nokia", "dragon", 4, 16, 6, 720, 500000, false);
        listaCell.add(nuevo);
        nuevo = new cell("sony", "dragon2", 6, 16, 5.7, 900, 600000, false);
        listaCell.add(nuevo);
        */
        listaCell=new ArrayList<cell>();
        listaCell = (ArrayList<cell>) dao.cellDAO.obtenerDatos();
        for (int i = 0; i < listaCell.size(); i++) {
            System.out.println(listaCell.get(i).getBatery() + " " + listaCell.get(i).getCamera() +" "+ listaCell.get(i).getCost());
        }
        ...
        double cost = 0.0;
        boolean plan = false;
        cell nuevo = new cell(company,processor,ram,rom,camera,batery,cost,plan);
        
        //dao.cellDAO.obtenerDatos();
        
        nuevo.setCompany(company);
        nuevo.setProcessor(processor);
        nuevo.setRam(ram);
        nuevo.setRom(rom);
        nuevo.setCamera(camera);
        nuevo.setBatery(batery);
        nuevo.setCost(cost);
        nuevo.setPlan(plan);
